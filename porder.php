...
<a class="navbar-brand mr-1" > <h5 class="mt-2" style="color:black;"> You are in Orders Sector </h5> </a>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="osupplier.php">Order Products From Supplier</a>
                    </li>
                    <li class="breadcrumb-item">
                        <a href="ocustom.php">Customers Orders</a>
                    </li>
            ...
            <?php
            $query = "SELECT  top 10 product_Order.orderID,custom_Order.orderDate,custom_Order.deliverDate, customers.shopName
            FROM custom_Order,customers
            INNER JOIN product_Order ON product_Order.orderID=product_Order.orderID";
