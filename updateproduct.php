...
<div class="">
  <br><br>
  <h5>By clicking Add Update Products ,you can Update Products</h5>
  <br>
  <p> </p>

  
  <!-- Button to Open the Modal Add Customers-->
  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Update Products
  </button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Update Products
    </h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
     <!-- Modal body -->
        <div class="modal-body">
     <form class="login100-form validate-form p-b-33 p-t-5" action="updateproduct.php" method="post">
        
   <div class="wrap-input100 validate-input" data-validate="Enter product ID">
                        <input class="input100" type="text" name="productID" placeholder="Enter Customer ID wants to update"  required>
