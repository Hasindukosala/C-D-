        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Products Overview</li>
                </ol>
                <hr>
                    ...
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="addproduct.php" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Product</span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <script>
                        function slotDelete(b) {
                            ...
                            if (window.confirm("Do you really want to Delete ?")) {
                                window.location.href = "products.php?delete=1&productID=" + id + " ";
                            }
                        }
                    </script>
                  </body>
