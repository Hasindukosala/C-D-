...
if(isset($POST['update'])){
   ...
   $sql2 = "UPDATE customers
    ...
    $param = array($customerName, $contactNum, $address1, $address2, $shopName);
    $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
    $stmt2= sqlsrv_query($conn, $sql2 , $param, $options );
...
<div class="">
  <br><br>
  <h5>By clicking Update Customers ,you can Insert Update Customers</h5>
  <br>
  <p> </p>

  
  <!-- Button to Open the Modal Add Customers-->
  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Update Customers
  </button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Update Customers
    </h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
     <!-- Modal body -->
        <div class="modal-body">
     <form class="login100-form validate-form p-b-33 p-t-5" action="updatecustomer.php" method="post">
        
   <!-- <div class="wrap-input100 validate-input" data-validate="Enter Customer ID">
                        <input class="input100" type="text" name="customerID" placeholder="Enter Customer ID wants to update"  required>
      ...
      <div class="modal-footer">
          <input type="submit" class="btn btn-warning"  name="update" value="Update" data-dismiss="">
